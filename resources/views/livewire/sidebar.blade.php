...
x-init="
 $wire.shrink={{request()->routeIs('/')|| request()->routeIs('/')}}
"
    ...
    <ul class="space-y-4 mt-2">
        ...
        <li><a wire:navigate href="/" class="flex items-center gap-5 ">
                ...
                <h4 x-cloak x-show="!(shrink||drawer)"
                    class=" text-lg  {{request()->routeIs('/')?'font-bold':'font-medium'}}">Home</h4>
            </a></li>
        ...
        <li><a wire:navigate href="{{route('/')}}" class="flex items-center gap-5">
                ...
                <h4 x-cloak x-show="!(shrink||drawer)"
                    class=" {{request()->routeIs('/')?'font-bold':'font-medium'}} text-lg ">Explore</h4>
            </a></li>
        ...
        <li><a wire:navigate href="{{route('/')}}" class="flex items-center gap-5">
                ...
                <h4 x-cloak x-show="!(shrink||drawer)"
                    class=" text-lg  {{request()->routeIs('/')?'font-bold':'font-medium'}}">Reel</h4>
            </a></li>
        ...
        <li><a wire:navigate href="{{route('/')}}" class="flex items-center gap-5">
                ...
                <span>
                    @if (request()->routeIs('/') || request()->routeIs('/'))
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        viewBox="0 0 16 16">
                        <path
        ...
        <li>
            <a wire:navigate href="{{route('/')}}" class="flex items-center gap-5">


                <x-avatar src="assets/headshot.png" class=" w-7 h-7 shrink-0" />

                <h4 x-cloak x-show="!(shrink||drawer)"
                    class=" text-lg  {{request()->routeIs('/')?'font-bold':'font-medium'}} ">Profile</h4>
            </a>
        </li>
        @endauth
